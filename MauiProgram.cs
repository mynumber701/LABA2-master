    ...
    public static class MauiProgram
    {
        ...
        public class Sax : IStrategy
        {
            public List<Publication> Search(Publication publication)
            {
                ...
                XmlTextReader xmlReader = new XmlTextReader(@"C:\Users\Tanya\source\repos\LABA2-master\Platforms\Windows\xmlhelp\XMLFile1.xml");
        ...
        public class Dom : IStrategy
        {
            public List<Publication> Search(Publication publication)
            {
                ...
                doc.Load(@"C:\Users\Tanya\source\repos\LABA2-master\Platforms\Windows\xmlhelp\XMLFile1.xml");
        ...
        public class Linq : IStrategy
        {
            ...
            {
                List<Publication> results = new List<Publication>();
                var doc = XDocument.Load(@"C:\Users\Tanya\source\repos\LABA2-master\Platforms\Windows\xmlhelp\XMLFile1.xml");
